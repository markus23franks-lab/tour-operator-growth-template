...
const baseline={metric:'Direct bookings',unit:'bookings',value:'12',period:'7-day window',startedAt:'2026-09-04',observedAt:'2026-09-10',source:'Booking system report'};
...
reject(()=>api.baseline(claim,{...baseline,startedAt:'2026-09-11'}),'reversed baseline window');
...
const later={value:'19',period:'7-day window',startedAt:'2026-09-14',observedAt:'2026-09-20',source:'Booking system report'};
reject(()=>api.followUp(claim,{...later,period:'30-day window'}),'comparing incompatible periods');
reject(()=>api.followUp(claim,{...later,startedAt:'2026-09-11',observedAt:'2026-09-17'}),'follow-up overlaps action');
reject(()=>api.followUp(claim,{...later,startedAt:'2026-09-13'}),'different length with identical label');
const measured=api.followUp(claim,later);
...
reject(()=>api.followUp(claim,{...later,startedAt:'2026-09-20',observedAt:'2026-09-24'}),'follow-up windows overlap');
