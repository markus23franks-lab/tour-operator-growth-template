...
const context={window:{},localStorage:{getItem:key=>store.get(key)||null},console,URL,Date};vm.createContext(context);vm.runInContext(readFileSync('js/research-backed-dashboard.js','utf8'),context);
