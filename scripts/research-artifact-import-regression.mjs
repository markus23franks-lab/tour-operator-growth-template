...
const claim={claimId:'claim_0',type:'QUICK_WIN',headline:'Promote canine cruise',evidenceIds:['page1'],supportQuotes:[{evidenceId:'page1',quote:'Canine Cruise tickets start at $46'}],scope:{pages:['https://operator.example/canine']},provenance:{hasDetailPage:true,verifiedQuoteCount:1}};
