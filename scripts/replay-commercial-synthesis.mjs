...
try{
 ...
 output={state:'PROOF_JUDGED',website:source.summary.website,dossier,sourceEvidenceRecords:evidence.length,visibleEvidenceRecords:selected.evidence.length,judgment:result.synthesis,claimLedger:result.claimLedger,actionPlan:buildOperatorActionPlan({ledger:result.claimLedger,synthesis:result.synthesis}),discardedQuotes:result.discardedQuotes,normalizedQuotes:result.normalizedQuotes,usage};
}catch(error){
