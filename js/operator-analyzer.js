...
async function runDedicatedOperatorResearch(ctx, market, acquisition) {
  ...
  return {version:'GO-OPERATOR-RESEARCH-V10',dossier,pricing,offerComparison,trust,conversion,bookingJourney,productArchitecture,competition,positioning,positioningComparison,brain,actionPlan,researchPlans:{discovery:discoveryQueries.slice(0,5),pricing:pricingPlan,trust:trustPlan},evidence:{pricingMarket:pricingMarket?{provider:pricingMarket.provider||'SerpApi',observedAt:pricingMarket.observedAt||'',queries:pricingMarket.queries||[]}:null,trustMarket:trustMarket?{provider:trustMarket.provider||'SerpApi',observedAt:trustMarket.observedAt||'',queries:trustMarket.queries||[],target:trustMarket.target||null}:null}};
}
