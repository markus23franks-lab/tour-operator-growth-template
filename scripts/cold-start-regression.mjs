...
const fixtures=[
 ...
 {name:'Food ignores incidental destination activities',location:'Louisville, Kentucky',text:'Louisville food tours and guided walking food experiences through downtown. Guests learn about local history near the riverboats and waterfront. Private boat charters are one of many things visitors can find elsewhere in Louisville.',must:['food tours'],forbid:['private boat charters','boat tours']},
