...
if(!src.includes('await enrichQualifiedCompetitorEvidence(market,competition)'))failures.push('qualified competitors must be enriched before offer/positioning comparison');
