...
function build({dossier,pricing,competitors=[]}={}){
 ...
 return {version:'GO-OFFER-COMPARISON-V3',state,headline,action,matches:matches.slice(0,8),sources:sources.size,evidenceNote:'Missing duration or format is not treated as proof of equivalence. GO requires structured competitor offers and multiple independent matches before promoting pricing strategy.'};
}
