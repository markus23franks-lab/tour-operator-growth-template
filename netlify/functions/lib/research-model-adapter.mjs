...
async function callStructured({model,apiKey,name,schema,instructions,input,onUsage}){
 ...
 const body={model,input:[{role:"user",content:[{type:"input_text",text:inputText}]}],instructions,store:false,max_output_tokens:6000,text:{format:{type:"json_schema",name,strict:true,schema}}};
